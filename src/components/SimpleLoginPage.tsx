...
import brainIllustration from 'figma:asset/4dece2b043ab524c73c9b214ce93df13af817924.png';
      ...
      <div className="container mx-auto px-4 py-4">
        <div className="grid lg:grid-cols-2 gap-8 items-center max-w-7xl mx-auto">
          ...
          <div className="space-y-8">
            ...
            <div>
              <h1 className="text-3xl lg:text-4xl mb-4">
                Bienvenue sur <span style={{ color: '#4f7cff' }}>QE.tn</span>
              </h1>
          ...
          <div className="flex justify-center lg:justify-end">
            <Card className="w-full max-w-md p-6 bg-white shadow-xl border-0 rounded-2xl">
